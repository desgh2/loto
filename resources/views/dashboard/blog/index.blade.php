                ...
                <table class="table">
                    ...
                    @foreach ($blogs as $blog)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('blog.status', ['blog' => $blog->id]) }}" method="POST">
                                    @csrf
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="status-{{ $blog->id }}" name="status" onchange="this.form.submit();" {{ $blog->published ? 'checked' : '' }}>
                            ...
                            <td><a href="{{ route('blog.edit', ['blog' => $blog->id]) }}" class="btn btn-warning">
